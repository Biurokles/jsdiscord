    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="focus:outline-none" asChild>
                <button className="w-full text-md font-semibold px-3 flex items-center h-12 border-neutral-200 dark:border-netrual-800 border-b-2 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/15 transition">
                    {server.name}
